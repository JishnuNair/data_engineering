...
case when primaryProfession = '\\N' then NULL else JSON_EXTRACT_ARRAY(primaryProfession) end as professions,
case when knownForTitles = '\\N' then NULL else JSON_EXTRACT_ARRAY(knownForTitles) end as known_for_titles
